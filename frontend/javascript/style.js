...
const list_contact = [
    {'href':'https://www.facebook.com/Xie Yan', 'icon':'<i class="fa-brands fa-square-facebook"></i>', 'text':'WanRzy'},
    {'href':'https://www.instagram.com/ritz.404/#', 'icon':'<i class="fa-brands fa-square-instagram"></i>', 'text':'WanRzy'},
    {'href':'https://github.com/Ritz404', 'icon':'<i class="fa-brands fa-square-github"></i>', 'text':'WanRzy'},
];
